...
#define PG_MAX_BINDLESS_MATERIALS 65536
#define PG_INVALID_MATERIAL_INDEX 0

#define PG_BINDLESS_SAMPLED_TEXTURE_DSET_BINDING 0
#define PG_BINDLESS_STORAGE_IMAGE_DSET_BINDING 1
#define PG_SCENE_GLOBALS_DSET_BINDING 2
#define PG_BINDLESS_BUFFER_DSET_BINDING 3
#define PG_BINDLESS_MATERIALS_DSET_BINDING 4
#define PG_BINDLESS_SAMPLERS_DSET_BINDING 5
