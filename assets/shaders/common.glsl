...
DEFINE_STANDARD_BUFFER_REFERENCE( 1, ByteBuffer, uint8_t );
DEFINE_STANDARD_BUFFER_REFERENCE( 2, UshortBuffer, uint16_t );
DEFINE_STANDARD_BUFFER_REFERENCE( 4, UintBuffer, uint );
DEFINE_STANDARD_BUFFER_REFERENCE( 4, UVec2Buffer, uvec2 );
