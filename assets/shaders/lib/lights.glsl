...
uint UnpackLightType( const PackedLight packedL ) { return uint( packedL.colorAndType.w ); }
...
float PointLightAttenuation( vec3 pos, PointLight l ) { return LightDistanceAttenuation( l.position, pos, l.invRadiusSquared ); }
