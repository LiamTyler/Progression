...
VkDescriptorSet DescriptorSet::GetHandle() const { return m_handle; }
DescriptorSet::operator bool() const { return m_handle != VK_NULL_HANDLE; }
...
VkDescriptorSetLayout DescriptorSetLayout::GetHandle() const { return m_handle; }
DescriptorSetLayout::operator bool() const { return m_handle != VK_NULL_HANDLE; }
...
std::vector<DescriptorSet> DescriptorPool::NewDescriptorSets(
...
DescriptorSet DescriptorPool::NewDescriptorSet( const DescriptorSetLayout& layout, const std::string& name ) const
{
    ...
    VK_CHECK( vkAllocateDescriptorSets( m_device, &allocInfo, (VkDescriptorSet*)&descriptorSet.m_handle ) );
    PG_DEBUG_MARKER_IF_STR_NOT_EMPTY( name, PG_DEBUG_MARKER_SET_DESC_SET_NAME( descriptorSet, name ) );

    return descriptorSet;
}

VkDescriptorPool DescriptorPool::GetHandle() const { return m_handle; }
DescriptorPool::operator bool() const { return m_handle != VK_NULL_HANDLE; }
