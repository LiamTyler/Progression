...
constexpr VkCullModeFlagBits PGToVulkanCullFace( CullFace face ) { return static_cast<VkCullModeFlagBits>( face ); }

constexpr VkPolygonMode PGToVulkanPolygonMode( PolygonMode mode ) { return static_cast<VkPolygonMode>( mode ); }
...
constexpr VkSamplerMipmapMode PGToVulkanMipFilter( MipFilterMode mode ) { return static_cast<VkSamplerMipmapMode>( mode ); }

constexpr VkSamplerAddressMode PGToVulkanWrapMode( WrapMode mode ) { return static_cast<VkSamplerAddressMode>( mode ); }

constexpr VkBorderColor PGToVulkanBorderColor( BorderColor color ) { return static_cast<VkBorderColor>( color ); }
