...
namespace Gfx
{
    ...
    PipelineStageFlags GetPipelineStageFlags( ImageLayout imageLayout )
    {
        ...
        case ImageLayout::UNDEFINED:
			return PipelineStageFlags::TOP_OF_PIPE_BIT;
		case ImageLayout::PREINITIALIZED:
			return PipelineStageFlags::HOST_BIT;
		case ImageLayout::TRANSFER_DST:
		case ImageLayout::TRANSFER_SRC:
			return PipelineStageFlags::TRANSFER_BIT;
		case ImageLayout::COLOR_ATTACHMENT:
			return PipelineStageFlags::COLOR_ATTACHMENT_OUTPUT_BIT;
        case ImageLayout::DEPTH_STENCIL_ATTACHMENT:
        case ImageLayout::DEPTH_ATTACHMENT:
        case ImageLayout::STENCIL_ATTACHMENT:
			return PipelineStageFlags::EARLY_FRAGMENT_TESTS_BIT | PipelineStageFlags::LATE_FRAGMENT_TESTS_BIT;
        ...
        case ImageLayout::STENCIL_READ_ONLY:
			return PipelineStageFlags::VERTEX_SHADER_BIT | PipelineStageFlags::FRAGMENT_SHADER_BIT;
        case ImageLayout::PRESENT_SRC_KHR:
			return PipelineStageFlags::BOTTOM_OF_PIPE_BIT;
		...
		default:
			PG_ASSERT( false, "unknown ImageLayout in GetPipelineStageFlags" );
			return PipelineStageFlags::NONE;
	    }
    }
