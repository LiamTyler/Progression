...
void Shader_Parse( const rapidjson::Value& value )
{
    ...
    if ( g_converterConfigOptions.noShaderOptimization )
    {
        info.optimize = false;
    }
    info.writePreproc = g_converterConfigOptions.saveShaderPreproc;
