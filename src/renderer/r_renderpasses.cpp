...
{
    RenderPassDescriptor renderPassDesc;
    renderPassDesc.AddColorAttachment( PixelFormat::R16_G16_B16_A16_FLOAT, LoadAction::CLEAR, StoreAction::STORE, glm::vec4( 0 ), ImageLayout::UNDEFINED, ImageLayout::SHADER_READ_ONLY_OPTIMAL );
